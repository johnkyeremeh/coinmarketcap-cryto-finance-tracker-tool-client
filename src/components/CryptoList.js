        ...
        <TableBody>
          {records.map(row => (
            ...
            >
              ...
              <TableCell align="right">{row.quote.USD.percent_change_1h}</TableCell>
              <TableCell align="right">{row.quote.USD.percent_change_24h}</TableCell>
              <TableCell  align="right">{row.quote.USD.percent_change_7d}</TableCell>
